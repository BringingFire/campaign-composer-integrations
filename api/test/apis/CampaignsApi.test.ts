import { CampaignsApi, Configuration, DocumentsApi, EntitiesApi, FoldersApi, ImagesApi, LinksApi, MapsApi } from '../../dist/typescript/dist';
import { TEST_CAMPAIGNS_EXPECT_LENGTH, TEST_CAMPAIGN_ID, TEST_DOCUMENTS_EXPECT_LENGTH, TEST_DOCUMENT_ID, TEST_ENTITIES_EXPECT_LENGTH, TEST_ENTITIES_WITH_FOLDER_EXPECT_LENGTH, TEST_ENTITY_ID, TEST_FOLDERS_EXPECT_LENGTH, TEST_FOLDER_ID, TEST_IMAGES_EXPECT_LENGTH, TEST_IMAGE_ID, TEST_LINKS_EXPECT_LENGTH, TEST_LINK_ID, TEST_LINK_URL, TEST_MAPS_EXPECT_LENGTH, TEST_MAP_EXPECT_WIDTH, TEST_MAP_ID } from './data';
